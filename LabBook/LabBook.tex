...
% \begin{figure}[h]
%   \center
%   \subfigure[]{ \label{fig:label1}
%     \includegraphics[width=.45\columnwidth]{fig1.png}
%   }
%   \subfigure[]{ \label{fig:label2}
%     \includegraphics[width=.45\columnwidth]{fig2.png}
%   }
%   \caption{\small Capation}
%   \label{fig:fig1}
% \end{figure}
